...
#              os.path.exists(f'{self.segmenter.outputFolder}{os.sep}{CONF_FOLDER_NAME}{os.sep}{CONFIG_COPY_FILENAME}')):
...
#           shutil.copy(f'{conf_folder_path}{os.sep}{CONFIG_COPY_FILENAME}', CONFIG_FILE_PATH)
#
...
#             yaml.safe_dump(self.config_yaml, file)
#
#        configureSegmentationWindow = ConfigureSegmentationWindow(self.segmenter, self.modality, self.edit_conf, self.config_yaml)
#        configureSegmentationWindow.show()
#
#    def set_default_values(self):
#        self.config_yaml['is_display_timer_requested'] = self.display_timer_checkbox.isChecked()
#
#    def populate_default_values(self):
#         self.display_timer_selected = self.config_yaml['is_display_timer_requested']
